...
{
    const config = electron_1.remote.require('./config').default;
    const invoice = electron_1.remote.require('./invoice');
    Polymer({
         ...
         */
        getInvoiceData() {
            const { laskunumero, maksuehto, viivästyskorko } = config.get('invoiceSettings');
            return {
